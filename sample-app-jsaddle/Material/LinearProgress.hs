...
primaryBarElt =
    div_ [ class_"mdc-linear-progress__bar mdc-linear-progress__primary-bar" ]
        [ barInnerElt ]


secondaryBarElt :: View msg
secondaryBarElt =
    div_ [ class_"mdc-linear-progress__bar mdc-linear-progress__secondary-bar" ]
        [ barInnerElt ]
